...
interface SidebarProps {
  dict: Pick<
    DashboardDict,
    "sidebarTitle" | "myAccount" | "purchases" | "schedule" | "reports" | "settings"
  >;
  lang: string;
}
...
export function Sidebar({ dict, lang }: SidebarProps) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[220px] flex-shrink-0 border-r border-outline/15 min-h-[calc(100vh-88px)]">
      <div className="px-6 py-6 border-b border-outline/15">
        <span className="text-[10px] tracking-[0.28em] uppercase text-outline font-semibold">
          {dict.sidebarTitle}
        </span>
      </div>
